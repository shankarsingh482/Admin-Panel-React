...
import { show_close_support_api } from './Support_api';
...
export default function CloseSupport(props) {
    ...
    const getData = () => {
        show_close_support_api().then((res) => {
    ...
    return (
        <React.Fragment>
            <Helmet>
                <title>Close Supports</title>
            </Helmet>
            <h2>Close Supports</h2>
            <br />
