...
export default function Support_management(props) {
  const classes = useStyles();

  return (
    <React.Fragment>
      <Helmet>
        <title>Suport Management</title>
      ...
      <Grid container spacing={3} direction="row" alignItems="stretch">
        <Grid item lg={4} xs={12} md={6} sm={6} >
          <Link to='/open_supports' className={classes.link}>
        ...
        <Grid item lg={4} xs={12} md={6} sm={6} >
          <Link to='/close_supports' className={classes.link}>
            <Paper className={classes.paper} elevation={5}>
              <Grid container>
                <Grid item xs={12} sm={5} align='center'>
                  <Animated animationIn="zoomIn" animationOut="pulse" animationInDuration={1000} animationOutDuration={1000} isVisible={true}>
